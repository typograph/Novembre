/*
 * This file is part of Novembre Plugin Interface
 * 
 * NVBSettingsWidget for plugins to publish settings to the global settings dialog.
 * Copyright (C) 2011 Timofey Balashov <typograph@elec.ru>
 *
