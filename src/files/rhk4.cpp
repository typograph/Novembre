...
void RHK4FileGenerator::useSettings(const QSettings * confile) {
	if (confile)
...
QString RHK4FileGenerator::getLineTypeString(qint32 type) {
	switch (type) {
		...
		case  9:
			return "Image X Average";

		case 10:
			return "Image Y Average";

		case 11:
			return "Noise autocorrelation spectrum";

		case 12:
			return "Multichannel analyzer data";

		case 13:
			return "Renormalized IV data from variable gap IV";

		case 14:
			return "Image histogram spectra";

		case 15:
			return "Image cross section";

		case 16:
			return "Image average";

		case 17:
			return "Image cross section"; // What the hell?

		case 18:
			return "Image out spectra";

		case 19:
			return "Datalog spectrum";
...
QString RHK4FileGenerator::getPageDataTypeString(qint32 type) {
	switch (type) {
		...
		case 1 :
			return "Line/Spectral data";

		case 2 :
			return "XY data";

		case 3 :
			return "Annotated line/spectral data";

		case 4 :
			return "Text data";

		case 5 :
			return "Annotated text data";
...
QString RHK4FileGenerator::getPageTypeString(qint32 type) {
	switch (type) {
		...
		case 13 :
			return "Image IV 16x16";

		case 14 :
			return "Image IV 32x32";

		case 15 :
			return "Image IV center";

		case 16 :
			return "Image interactive spectra";

		case 17 :
			return "Autocorrelation page";

		case 18 :
			return "IZ spectra";

		case 19 :
			return "4 gain topography";

		case 20 :
			return "8 gain topography";

		case 21 :
			return "4 gain current";

		case 22 :
			return "8 gain current";

		case 23 :
			return "Image IV 64x64";
		...
		case 27 :
			return "AFM data using RHK AFM-100";
		...
		case 37 :
			return "Image + Discrete spectroscopy";

		case 38 :
			return "Ramp spectroscopy at relative points";

		case 39 :
			return "Discrete spectroscopy at relative points";
...
QString RHK4FileGenerator::getObjectTypeString(qint32 type) {
	switch (type) {
		...
		case  5 :
			return "Image Drift Header";

		case  6 :
			return "Image Drift";

		case  7 :
			return "Spec Drift Header";

		case  8 :
			return "Spec Drift Data";
		...
		case 11 :
			return "Tip Track Header";

		case 12 :
			return "Tip Track Data";
